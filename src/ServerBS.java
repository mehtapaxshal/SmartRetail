...
/**
 * Servlet implementation class ServerBS
 */
@WebServlet("/ServerBS")
public class ServerBS extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  public String ReceiveBS(){
	    	...
	    	WebResource webResource = client.resource("http://localhost:8080/Assignment2/rest/client/BootStrap/Server");
