 ...
 <div class="pricing-plans">
									...
									<div class="pop_up">
									 	<div class="payment-online-form-left">
											<form>
												...
												<ul>
													<li><input class="text-box-dark" type="text" value="First Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Frist Name';}"></li>
	...
	<!--//End-pricingplans-->
		<!-- /start-copyright-->
				<div class="footer">
					<div class="wrap">
							<p>&copy; 2016  All rights  Reserved | Template by &nbsp;<a href="">Smart Retail Team-05</a></p>
					</div>							
				</div>
		<!--//End-copyright-->
</body>
